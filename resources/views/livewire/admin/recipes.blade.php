<div>
    ...
    <div class="bg-white rounded-md shadow-md p-10 ">
            ...
            <tr class="bg-white lg:hover:bg-gray-100 flex lg:table-row flex-row lg:flex-row flex-wrap lg:flex-no-wrap mb-10 lg:mb-0">
              <td class="w-full lg:w-auto p-3 text-gray-800 border border-b lg:table-cell relative lg:static h-24 flex items-center justify-center md:h-auto">
                ...
                <div class="flex items-center justify-center md:justify-start">
                  <div class=" flex-shrink-0 h-10 ">
                    <img class="h-10 w-10 rounded-full" src=" {{asset('storage/' . $recipe->recipeImages()->first()->image) }}" alt="">
                  </div>
              ...
              <td
                ...
                <div class="flex justify-center">
                  ...
                  <a href="#" onclick="confirmAction('deleteRecipe', {{ $recipe }});"
                    data-title='Elimina la receta' data-placement="top"
        ...
        @else
          <x-icons.no-recipes />
          <x-utils.text class="text-center mb-6">¡Al parecer no hay recetas! Puedes agregar haciendo clic en el botón AGREGAR que esta abajo</x-utils.text>
          <hr class=" border-eat-olive-50 mb-6 ">
        @endif
