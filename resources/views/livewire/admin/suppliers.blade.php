<div>
    ...
    <div class="bg-white rounded-md shadow-md p-10 ">
          ...
          <table class="border-collapse w-full">
            ...
            <tbody>
              ...
              <tr class="bg-white lg:hover:bg-gray-100 flex lg:table-row flex-row lg:flex-row flex-wrap lg:flex-no-wrap mb-10 lg:mb-0">
                <td class="w-full lg:w-auto p-3 text-gray-800 border border-b lg:table-cell relative lg:static h-24 flex items-center justify-center md:h-auto">
                ...
                <td class="w-full lg:w-auto p-3 text-gray-800 border border-b lg:table-cell relative lg:static  flex items-center justify-center md:h-auto">
                ...
                <td
                  class="w-full lg:w-auto p-3 text-gray-800 border border-b lg:table-cell relative lg:static h-24 flex items-center justify-center md:h-auto">
                  <span class="lg:hidden absolute top-0 left-0 bg-blue-200 px-2 py-1 text-xs font-bold uppercase">Website</span>
                  <a href="http://{{$supplier->website}}" target="_blank"><p class="text-sm font-montserrat text-center">{{$supplier->website}}</p></a>
                </td>
        ...
        @else
        <x-icons.not-found />
        <x-utils.text class="text-center mb-6">¡Al parecer no hay proveedores! Puedes agregar haciendo clic en el botón AGREGAR que esta abajo</x-utils.text>
        <hr class=" border-eat-olive-50 mb-6 ">
        @endif
