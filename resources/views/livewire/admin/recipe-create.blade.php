<div>
    ...
    <<<<<<< HEAD {{-- <div x-data="{tab:0}"> --}} <div x-data="{ tab: @entangle('tabSelection') }">
        <nav>
            ...
            <div x-show="tab===0" class="block lg:grid grid-cols-1 gap-4 place-items-center">
                <div class="col-span-1 w-2/3 my-8">
                            ...
                            border border-transparent  focus:outline-none focus:ring-2 focus:ring-eat-olive-600 focus:border-transparent"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <x-utils.text-input wire:model="prepTime"
                                                                                type="number"
                                                                                label="Tiempo de preparación"
                                                                                :required="true" placeholder="00"
                                                                                class="w-full mr-2" />
                                                                            <p
                                                                        ...
                                                                        <div
                                                                            class="mb-2 md:mb-0 flex items-center relative w-full md:w-1/3">
                                                                            <x-utils.text-input wire:model="cookTime"
                                                                                type="number" label="Tiempo de cocción"
                                                                                :required="true" placeholder="00"
                                                                                class="w-full mr-2" />
                                                                            <p
                                                                                class="absolute top-8 left-16 text-eat-olive-600 text-sm">
                                                ...
                                                <<<<<<< HEAD <div x-show="tab===2"
                                                    ...
                                                    <div class="col-span-1 w-2/3 my-8">
                                                        ...
                                                        <p
                                                            class="block text-sm font-medium leading-5 text-eat-olive-700 mb-2">
                                                            Información
                    ...
                    border-transparent focus:outline-none focus:ring-2 focus:ring-eat-olive-600 focus:border-transparent">
                                                                <span
                                                                    class="ml-2 text-eat-olive-500 font-montserrat">Tamaño</span>
                                                            </label>
                                                            <x-utils.text-input wire:model="servingSize" type="text"
                                                        ...
                                                        <div class="flex items-center mb-2">
                                                            <label for="" class="w-3/12 flex items-center">
                                                                <input type="checkbox" id="" value="Calorias"
                                                                    wire:model="calorias"
                                                                    class="form-input bg-eat-green-500 text-eat-olive-900 font-montserrat placeholder-eat-olive-50 border
                  border-transparent focus:outline-none focus:ring-2 focus:ring-eat-olive-600 focus:border-transparent">
                                                                <span
                                                            ...
                                                            <x-utils.text-input wire:model="calories" type="text"
                                                                label="" :required="false"
                  ...
                  border-transparent focus:outline-none focus:ring-2 focus:ring-eat-olive-600 focus:border-transparent">
                                                            ...
                                                            <x-utils.text-input wire:model="carbohydrateContent"
                                                                type="text" label="" :required="false"
                                                                placeholder="Carbohidratos por porción"
                                                                class="w-2/3 mt-0" />
                                                        </div>
                  ...
                  border-transparent focus:outline-none focus:ring-2 focus:ring-eat-olive-600 focus:border-transparent">
                                                            ...
                                                            <x-utils.text-input wire:model="cholesterolContent"
                                                                type="text" label="" :required="false"
                                                                placeholder="Colesterol por porción"
                                                                class="w-2/3 mt-0" />
                                                        </div>

                                                        <div class="flex items-center mb-2">
                                                            <label for="" class="w-3/12 flex items-center">
                                                                <input type="checkbox" id="" value="Grasas"
                                                                    wire:model="Grasas"
                                                                    class="form-input bg-eat-green-500 text-eat-olive-900 font-montserrat placeholder-eat-olive-50 border
                  border-transparent focus:outline-none focus:ring-2 focus:ring-eat-olive-600 focus:border-transparent">
                                                                <span
                                                                    class="ml-2 text-eat-olive-500 font-montserrat">Grasas</span>
                                                            </label>
                                                            <x-utils.text-input wire:model="fatContent" type="text"
                                                                label="" :required="false"
                  ...
                  border-transparent focus:outline-none focus:ring-2 focus:ring-eat-olive-600 focus:border-transparent">
                                                                <span
                                                                    class="ml-2 text-eat-olive-500 font-montserrat">Grasas
                                                                    Saturadas</span>
                                                            </label>
                                                            <x-utils.text-input wire:model="saturatedFatContent"
                                                                type="text" label="" :required="false"
                                                                placeholder="Grasas Saturadas por porción"
                                                                class="w-2/3 mt-0" />
                                                        </div>
                  ...
                  border-transparent focus:outline-none focus:ring-2 focus:ring-eat-olive-600 focus:border-transparent">
                                                            ...
                                                            <x-utils.text-input wire:model="transFatContent" type="text"
                                                                label="" :required="false"
                                                                placeholder="Grasas Trans por porción"
                                                                class="w-2/3 mt-0" />
                                                        </div>
                  ...
                  border-transparent focus:outline-none focus:ring-2 focus:ring-eat-olive-600 focus:border-transparent">
                                                            ...
                                                            <x-utils.text-input wire:model="unsaturatedFatContent"
                                                                type="text" label="" :required="false"
                                                                placeholder="Grasas No Saturadas por porción"
                                                                class="w-2/3 mt-0" />
                                                        </div>

                                                        <div class="flex items-center mb-2">
                                                            <label for="" class="w-3/12 flex items-center">
                                                                <input type="checkbox" id="" value="Fibra"
                                                                    wire:model="fibra"
                                                                    class="form-input bg-eat-green-500 text-eat-olive-900 font-montserrat placeholder-eat-olive-50 border
                  border-transparent focus:outline-none focus:ring-2 focus:ring-eat-olive-600 focus:border-transparent">
                                                                <span
                                                                    class="ml-2 text-eat-olive-500 font-montserrat">Fibra</span>
                                                            </label>
                                                            <x-utils.text-input wire:model="fiberContent" type="text"
                                                                label="" :required="false"
                                                        ...
                                                        <div class="flex items-center mb-2">
                                                            <label for="" class="w-3/12 flex items-center">
                                                                <input type="checkbox" id="" value="Proteína"
                                                                    wire:model="proteina"
                                                                    class="form-input bg-eat-green-500 text-eat-olive-900 font-montserrat placeholder-eat-olive-50 border
                  border-transparent focus:outline-none focus:ring-2 focus:ring-eat-olive-600 focus:border-transparent">
                                                                <span
                                                            ...
                                                            <x-utils.text-input wire:model="proteinContent" type="text"
                                                                label="" :required="false"
                                                        ...
                                                        <div class="flex items-center mb-2">
                                                            <label for="" class="w-3/12 flex items-center">
                                                                <input type="checkbox" id="" value="Sodio"
                                                                    wire:model="sodio"
                                                                    class="form-input bg-eat-green-500 text-eat-olive-900 font-montserrat placeholder-eat-olive-50 border
                  border-transparent focus:outline-none focus:ring-2 focus:ring-eat-olive-600 focus:border-transparent">
                                                                <span
                                                                    class="ml-2 text-eat-olive-500 font-montserrat">Sodio</span>
                                                            </label>
                                                            <x-utils.text-input wire:model="sodiumContent" type="text"
                                                                label="" :required="false"
                                                        ...
                                                        <div class="flex items-center mb-2">
                                                            <label for="" class="w-3/12 flex items-center">
                                                                <input type="checkbox" id="" value="Azúcar"
                                                                    wire:model="azucar"
                                                                    class="form-input bg-eat-green-500 text-eat-olive-900 font-montserrat placeholder-eat-olive-50 border
                  border-transparent focus:outline-none focus:ring-2 focus:ring-eat-olive-600 focus:border-transparent">
                                                                <span
                                                                    class="ml-2 text-eat-olive-500 font-montserrat">Azúcar</span>
                                                            </label>
                                                            <x-utils.text-input wire:model="sugarContent" type="text"
                                                                label="" :required="false"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="flex items-center justify-between">
                                                                        <input wire:model="ingredientQty" type="number"
                                                                            name="qty" min="1" max="999" value="1"
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div x-show="tab===2"
                                                                                class="block lg:grid grid-cols-1 gap-4 place-items-center">
                                                                                <div
                                                                                    class="col-span-1 md:w-2/3 my-8 mx-auto">
                                                                                    <div class="mt-6">
                                                                                ...
                                                                                <<<<<<< HEAD </div>
                                                                                    ...
                                                                                    <div x-show="tab===3"
                                                                                        class="block lg:grid grid-cols-1 gap-4 place-items-center">
                                                                                        <div
                                                                                            class="col-span-1 w-2/3 my-8 mx-auto">
                                                                                            <div
                                                                                                class=" text-eat-olive-500 mt-4 px-4">
                                                                                                <label
                                                                                    ...
                                                                                    <hr
                                                                                        class=" border-eat-olive-50 mb-6 ">
