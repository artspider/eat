                        ...
                        <div class="flex flex-col md:flex-row items-center mb-8">
                            <div class="mb-3 md:mb-0 flex items-center relative w-full md:w-2/5">
                                <x-utils.text-input wire:model="recipeYield" type="number" label="Rinde para"
                                    :required="true" placeholder="0" class="w-full md:mr-2" />
                        ...
                        <ul class="mt-8">
                            ...
                            <div class="flex items-center mt-4">
                                ...
                                <li class=" text-eat-olive-500 font-montserrat text-sm"> {{$ingredient['qty']}}
                                    {{$ingredient['unit']}} {{$ingredient['product']}} </li>
                            </div>
                            @endforeach
                        </ul>
                        @else
                            ...
                            <div class="flex items-center mx-auto justify-center">
                                <div class="flex flex-col items-center mr-4 sm:mr-0 sm:w-full sm:flex-row">
                                    ...
                                    <div class="flex items-center relative w-full order-1 md:w-1/3  sm:order-1">
                                        <x-utils.text-input wire:model="nutritionQty" type="number" label=""
                                            :required="false" placeholder="0" class="w-full md:mr-2" />
                                        <p class=" absolute top-3 left-14 text-eat-olive-600 text-sm">
                                            {{$nutritionUnitName}}</p>
                                    </div>
                                </div>
                                <x-icons.add wire:click.debounce.150ms="addNutritionItem()"
                        ...
                        <ul class="mt-8">
                            ...
                            <div class="flex items-center mt-4">
                                <p
                                    class="w-10 h-10 rounded-full pt-2 text-center mr-4 bg-eat-fuccia-500 text-eat-white-500 text-sm font-montserrat">
                                    {{$loop->index + 1}} </p>
                                <li class="text-eat-olive-500 font-montserrat text-sm"> {{$key}} {{$nutritionItem}}
                                </li>
                            </div>
                            @endforeach
                        </ul>
