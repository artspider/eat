<div>
  {{ Breadcrumbs::render('dishes-edit', $slug) }}

  <div class="bg-white rounded-md shadow-md p-10 ">
    <x-utils.subtitle class="mb-4">Editar platillo</x-utils.subtitle>
        ...
        <div x-show="tab===0" class="block lg:grid grid-cols-1 gap-4 place-items-center">
          <div class="col-span-1 w-2/3 my-8">
            ...
            <div class="flex items-center mb-8 ">
              ...
              <div class="relative w-1/2 mr-1">
                <x-utils.text-input disabled="true" wire:model="cost" type="text" label="Costo" :required="true"
                  placeholder="0" pl="pl-8" class="w-full mr-2" />
                <p class=" absolute top-9 left-4 text-eat-olive-600 text-sm">$</p>
                <p class=" absolute top-9 right-16 text-eat-olive-600 text-sm">MXN</p>
              </div>
            ...
            <div class="flex items-center justify-evenly">
              <p>Existe en stock?</p>
              @if ($inStock==true)
              <p wire:click="changeStock()"
                class="bg-eat-green-600 text-eat-olive-500 w-1/2 py-2 text-center cursor-pointer">Stock</p>
              @else
              <p wire:click="changeStock()"
                class="bg-eat-fuccia-600 text-eat-white-50 w-1/2 py-2 text-center cursor-pointer">
                Stock</p>
              @endif
            </div>
          </div>
          ...
          <div class="col-span-1 w-2/3 my-8">
            <div class=" text-eat-olive-500 mt-4 px-4">
              ...
              <div class="flex flex-wrap justify-center p-4">
                ...
                <img class=" w-1/4  h-20 " src="{{asset('storage/' . $photo_path) }}">
                @endforelse
...
<script>
  Livewire.on('success', message => {
    StayOrLeave(message,'¿Deseas agregar otro?','/admin/dishes');
  });
