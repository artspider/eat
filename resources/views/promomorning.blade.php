<x-layouts.master title="Welcome Page">
    <div class="bg-white rounded-md shadow-md p-10 ">
        <x-utils.subtitle class="mb-4">Editar paquete de almuerzos</x-utils.subtitle>
        ...
        <div x-data="{tab:0}">
            ...
            <form wire:submit.prevent="save">
                ...
                <div x-show="tab===1" class="grid grid-rows-1 lg:grid-rows-1 lg:grid-cols-1 gap-4 place-items-center">
                ...
                <div x-show="tab===2" class="grid grid-rows-1 lg:grid-rows-1 lg:grid-cols-1 gap-4 place-items-center">
                ...
                <div x-show="tab===3" class="grid grid-rows-1 lg:grid-rows-1 lg:grid-cols-1 gap-4 place-items-center">
                ...
                <div x-show="tab===4" class="grid grid-rows-1 lg:grid-rows-1 lg:grid-cols-1 gap-4 place-items-center">
                    <div class="col-span-1 w-full mx-auto md:w-5/6 lg:4/5 xl:w-2/3 my-8 flex flex-col items-center">
                        <label for="qty"
                            class="block mb-4 text-md font-medium leading-5 text-eat-olive-700 text-center">Platillo</label>

                        <div
                            class="flex flex-col sm:flex-row sm:justify-between w-full mx-auto justify-center text-center">
                            <div class="w-full md:w-full mr-1 xl:flex-grow">
                                <div x-data="{open: false}">
                                    <div class="relative">
                                        <div x-on:click="open=true"
