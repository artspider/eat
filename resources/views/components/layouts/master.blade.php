...
<body class="antialiased min-h-screen lg:flex" x-data="{open: false}">
    ...
    @endphp
    <nav class="absolute inset-0 transform lg:transform-none lg:opacity-100 duration-200 lg:relative z-10 w-full md:w-80 bg-eat-fuccia-500 text-white h-screen p-3"
