  ...
  <!-- Promocion semanal -->
    ...
    <div class="2xl:flex 2xl:flex-col">
      <div class="h-full 2xl:flex-1 rounded-md shadow-md lg:mr-4">
        <x-utils.subsubtitle class="p-5 text-center">Paquete semanal almuerzos</x-utils.subsubtitle>
      ...
      <div class="h-full 2xl:flex-1 rounded-md shadow-md lg:mr-4">
        <x-utils.subsubtitle class="p-5 text-center">Paquete semanal comidas</x-utils.subsubtitle>
      ...
      </div><!-- Comida semanal Comidas -->

      <div class="h-full 2xl:flex-1 rounded-md shadow-md lg:mr-4 2xl:mt-8">
        <x-utils.subsubtitle class="p-5 text-center">Promocion Diaria (Combo)</x-utils.subsubtitle>
          ...
          <div class="mx-4 pb-4 md:flex md:justify-between mt-4">
            <x-utils.subsubtitle class="ml-1 text-center my-2">Precio: <b class="text-gray-400">$</b><span class="text-gray-400">120.00</span> </x-utils.subsubtitle>
            <x-utils.button class="w-full md:w-48 justify-center " color="eat-fuccia">Editar promocion diaria</x-componets.button>
          </div>
      </div><!-- Comida diaria -->
      ...
      <div class="shadow-lg 2xl:w-1/3">
        ...
        <div>
            <div class="flex justify-around my-4 md:mb-16 cursor-pointer">
              <div>
                <img class="rounded-full w-24 h-24 transition-all transform translate hover:translate-x-2" src="https://randomuser.me/api/portraits/men/31.jpg" alt="">
              </div>
            ...
            <div class="flex justify-around mb-4 md:mb-16 cursor-pointer">
              <div>
            ...
            <div class="flex justify-around mb-4 md:mb-16 cursor-pointer">
              <div>
                <img class="rounded-full w-24 h-24 transition-all transform translate hover:translate-x-2" src="https://randomuser.me/api/portraits/men/40.jpg" alt="">
              </div>

              <div class="flex justify-center flex-col w-1/2">
                    <div class="flex justify-between items-center mb-3">
                      <p class="font-bold">Angel</p>
                      <div class="bg-eat-fuccia-500 w-8 h-8 rounded-full">
                      </div>
                    </div>
                    <div class="flex justify-between items-center mb-3">
            ...
            <div class="flex justify-around mb-4 md:mb-16 cursor-pointer">
              <div>
                <img class="rounded-full w-24 h-24 transition-all transform translate hover:translate-x-2" src="https://randomuser.me/api/portraits/women/1.jpg" alt="">
              </div>

              <div class="flex justify-center flex-col w-1/2">
                    <div class="flex justify-between items-center mb-3">
                      <p class="font-bold">Shairi</p>
                      <div class="bg-eat-green-500 w-8 h-8 rounded-full">
                      </div>
                    </div>
                    <div class="flex justify-between items-center mb-3">
                      <p class="font-bold">Hora de llegada</p>
                      <div class="">
                        <p class="font-bold text-gray-400">08:10<span>AM</span></p>
                      </div>
                    </div>
              </div>
            </div><!-- Termina user -->
            ...
            <div class="flex justify-around mb-4 md:mb-16 cursor-pointer">
              <div>
                <img class="rounded-full w-24 h-24 transition-all transform translate hover:translate-x-2" src="https://randomuser.me/api/portraits/women/3.jpg" alt="">
              </div>

              <div class="flex justify-center flex-col w-1/2">
                    <div class="flex justify-between items-center mb-3">
                      <p class="font-bold">Inéz</p>
                      <div class="bg-eat-green-500 w-8 h-8 rounded-full">
                      </div>
                    </div>
                    <div class="flex justify-between items-center mb-3">
                      <p class="font-bold">Hora de llegada</p>
                      <div class="">
                        <p class="font-bold text-gray-400">08:27<span>AM</span></p>
                      </div>
                    </div>
              </div>
            </div><!-- Termina user -->
