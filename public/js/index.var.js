...
/*!*******************************************!*\
  !*** ./resources/js/awesome/index.var.js ***!
  \*******************************************/
...
var AWN = function (t) {
  ...
  var r = {
    ...
    formatError: function formatError(t) {
      if (t.response) {
    ...
    return e = t, (n = [{
      ...
      value: function value(t, e) {
        ...
        for (var n = 0, o = ["general", e]; n < o.length; n++) {
          var i = o[n];
          if (this.replacements[i]) for (var r in this.replacements[i]) {
      ...
      value: function value(t, e) {
        ...
        for (var i in t) {
          e.hasOwnProperty(i) ? n[i] = "object" === o(t[i]) && null !== t[i] ? this.defaultsDeep(t[i], e[i]) : e[i] : n[i] = t[i];
        }
  ...
  var g = function (t) {
    ...
    return function (t, e) {
      ...
      value: function value() {
        var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : this.el;
        return t.classList.contains(l.klass.hiding);
      }
    }, {
      key: "progressBar",
      get: function get() {
